...
class MapboxRouteLayerProviderTest {
    ...
    var styleRes: Int = 0
    lateinit var routeLineScaleValuesList: List<RouteLineScaleValue>
    lateinit var routeLineTrafficScaleValuesList: List<RouteLineScaleValue>
    lateinit var routeLineCasingScaleValuesList: List<RouteLineScaleValue>
